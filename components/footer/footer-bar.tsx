      ...
      <div className="mx-auto flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            aria-label="YouTube"
            className="flex size-[41px] items-center justify-center rounded-full bg-white text-[#dcb6c9] transition-colors hover:bg-white/90"
          >
            <YouTubeIcon />
          </a>
          <a
        ...
        {/* Right: links */}
        <div className="flex items-center gap-4 text-[17px] text-white/90">
