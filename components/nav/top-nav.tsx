...
function YouTubeIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className="size-[clamp(16px,1.56vw,20px)]" aria-hidden>
            ...
            <div className="flex items-center gap-8 mr-4">
              {appNavItems.map((item) => (
                <Link
                  ...
                  href={item.href}
                  className={cn(
                    'text-[clamp(15px,1.48vw,19px)] transition-colors hover:text-white',
          ...
          {user ? (
            ...
            <>
              <div className="flex items-center gap-8">
                <Link href="/login" className="text-[clamp(15px,1.48vw,19px)] text-white/90 transition-colors hover:text-white">
                  Log In
                </Link>
                <Link href="/about" className={cn('text-[clamp(15px,1.48vw,19px)] transition-colors hover:text-white', pathname === '/about' ? 'text-[#8f6593]' : 'text-white/90')}>
                  About
                </Link>
                <Link href="/grandma-tips" className={cn('text-[clamp(15px,1.48vw,19px)] transition-colors hover:text-white', pathname === '/grandma-tips' ? 'text-[#8f6593]' : 'text-white/90')}>
                  Grandma Tips
                </Link>
              </div>
              <div className="flex items-center gap-4 ml-10">
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="YouTube"
                  className="flex size-[clamp(32px,3.13vw,40px)] items-center justify-center rounded-full bg-white text-[#dcb6c9] transition-colors hover:bg-white/90"
                >
                  <YouTubeIcon />
                </a>
                <a
